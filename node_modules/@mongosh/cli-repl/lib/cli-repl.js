...
const logging_2 = require("@mongosh/logging");
...
class CliRepl {
    ...
    async startLogging() {
        ...
        (_a = this.logManager) !== null && _a !== void 0 ? _a : (this.logManager = new mongodb_log_writer_1.MongoLogManager({
        ...
        if (!this.logWriter) {
            (_b = this.logWriter) !== null && _b !== void 0 ? _b : (this.logWriter = await this.logManager.createLogWriter());
        ...
        this.logWriter.info('MONGOSH', (0, mongodb_log_writer_1.mongoLogId)(1000000000), 'log', 'Starting log', {
    ...
    async start(driverUri, driverOptions) {
        ...
        this.loggingAndTelemetry = (0, logging_1.setupLoggingAndTelemetry)({
            bus: this.bus,
        ...
        const initialized = await this.mongoshRepl.initialize(initialServiceProvider, {
            ...
            currentVersionCTA: await this.updateNotificationManager.getGreetingCTAForCurrentVersion(),
        });
    ...
    async setupAnalytics() {
        ...
        this.toggleableAnalytics = new logging_2.ToggleableAnalytics(new logging_2.SampledAnalytics({
            target: new logging_2.ThrottledAnalytics({
    ...
    async setLoggingEnabled(enabled) {
        ...
        if (enabled) {
            ...
            (_a = this.loggingAndTelemetry) === null || _a === void 0 ? void 0 : _a.detachLogger();
        }
    }
    ...
    async fetchMongoshUpdateUrl() {
        ...
        try {
            ...
            await this.updateNotificationManager.fetchUpdateMetadata(updateURL, localFilePath, currentVersion);
            this.bus.emit('mongosh:fetching-update-metadata-complete', {
                ...
                currentVersion,
                hasGreetingCTA: !!(await this.updateNotificationManager.getGreetingCTAForCurrentVersion()),
            });
        }
        catch (err) {
