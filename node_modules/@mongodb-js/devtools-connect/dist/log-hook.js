...
function hookLogger(emitter, log, contextPrefix, redactURICredentials) {
    ...
    (0, devtools_proxy_support_1.hookLogger)(emitter, log, contextPrefix);
    ...
    emitter.on('devtools-connect:retry-after-tls-error', function (ev) {
        log.info('DEVTOOLS-CONNECT', mongoLogId(1000000054), `${contextPrefix}-connect`, 'Restarting connection attempt after TLS error', {
            error: ev.error,
        });
    });
}
