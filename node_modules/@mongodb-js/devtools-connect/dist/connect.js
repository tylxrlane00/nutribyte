...
async function connectMongoClientImpl({ uri, clientOptions, logger, MongoClientClass, useSystemCA, }) {
    ...
    try {
        ...
        const proxyAgent = clientOptions.proxy &&
            (0, devtools_proxy_support_1.useOrCreateAgent)('createConnection' in clientOptions.proxy
                ? clientOptions.proxy
                : {
                    ...clientOptions.proxy,
                    ...(ca ? { ca } : {}),
...
function addToOIDCPluginHttpOptions(existingOIDCPluginOptions, addedOptions) {
    const existingCustomOptions = existingOIDCPluginOptions?.customHttpOptions;
    if (typeof existingCustomOptions === 'function') {
        return {
            customHttpOptions: (url, options, ...restArgs) => existingCustomOptions(url, { ...options, ...addedOptions }, ...restArgs),
        };
    }
